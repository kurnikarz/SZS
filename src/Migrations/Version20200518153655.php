 ...
 */
final class Version20200518153655 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE rating DROP FOREIGN KEY FK_D88926227597D3FE');
        ...
        $this->addSql('ALTER TABLE rating DROP FOREIGN KEY FK_D8892622BEFD98D1');
